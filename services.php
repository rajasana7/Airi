...
<!-- Services Plan -->
  <section id="services-plan" class="py-5 text-center">
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <div class="card">
          ...
          <div class="col-md-6">
            <div class="card bg-light text-dark my-2">
              <div class="card-header" id="headingOne">
                <h5 class="mb-0">
                    <a href="#collapseOne" class="text-dark collapsed" data-toggle="collapse">Question One?</a>
                </h5>
              </div>
              <div id="collapseOne" class="collapse p-3"  data-parent="#accordion">
                <p class="lead mb-0">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Hic ex corporis, distinctio laboriosam eveniet illum quia veniam autem eligendi doloribus.
                </p>
              </div>
            </div>
            <div class="card bg-light text-dark my-2">
              <div class="card-header" id="headingTwo">
                <h5 class="mb-0">
                    <a href="#collapseTwo" class="text-dark collapsed" data-toggle="collapse">Question Two?</a>
                </h5>
              </div>
            ...
            <div class="card bg-light text-dark my-2">
              <div class="card-header" id="headingThree">
                <h5 class="mb-0">
                    <a href="#collapseThree" class="text-dark collapsed" data-toggle="collapse">Question Three?</a>
                </h5>
              </div>
          ...
          <div class="col-md-6">
            <div class="card bg-light text-dark my-2">
              <div class="card-header" id="headingFour">
                <h5 class="mb-0">
                    <a href="#collapseFour" class="text-dark collapsed" data-toggle="collapse">Question Four?</a>
                </h5>
              </div>
            ...
            <div class="card bg-light text-dark my-2">
              <div class="card-header" id="headingFive">
                <h5 class="mb-0">
                    <a href="#collapseFive" class="text-dark collapsed" data-toggle="collapse">Question Five?</a>
                </h5>
              </div>
            ...
            <div class="card bg-light text-dark my-2">
              <div class="card-header" id="headingSix">
                <h5 class="mb-0">
                    <a href="#collapseSix" class="text-dark collapsed" data-toggle="collapse">Question Six?</a>
                </h5>
              </div>
