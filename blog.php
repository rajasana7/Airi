            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="card-title">
                  <h4>Blog Post One</h4>
                  <small class="text-muted">Writtern By Chandan</small>
                  <hr>
                  <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sint, dolor. Officia voluptatem provident corporis error quae voluptate quo, qui facilis.</p>
